    ...
    <div className="p-8 space-y-6">
      <div className="flex justify-between items-start">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-900">Employee Tracker</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900 mt-2">Onboarding Progress</h1>
          <p className="text-gray-600 mt-1">Employee ID: {employeeIdDisplay}</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-lg border border-gray-200">
          ...
          <p className="text-lg font-semibold mt-1">{progress?.progressPercentage || 0}%</p>
        </div>
        <div className="bg-white p-5 rounded-lg border border-gray-200">
        ...
        <div className="bg-white p-5 rounded-lg border border-gray-200">
          ...
          <p className="text-lg font-semibold mt-1">Phase {currentPhase}</p>
        </div>
      </div>
            ...
            {ONBOARDING_PHASES.map((phase) => {
              ...
              return (
                <div key={phase.id} className="relative pl-10">
                  ...
                  >
                    <p className={`font-medium ${isCurrent ? 'text-blue-900' : isCompleted ? 'text-green-900' : 'text-gray-600'}`}>
                      {phase.name}
                    </p>
          ...
          {activeTab === 'documents' && (
            <div className="space-y-3">
              {documents.length === 0 ? (
                ...
                documents.map((doc) => (
                  <div key={doc._id} className="p-4 rounded-lg border border-gray-200 bg-gray-50">
                    <div className="flex justify-between items-start">
                      <div>
